              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`p-2 text-center bg-white rounded-md min-w-14 ${
                    sizeFilter === null ? "bg-orange-900 text-white" : ""
                  }`}>
                  All
                </button>
                <button
                  ...
                  className={`p-2 text-center bg-white rounded-md min-w-14 ${
                    sizeFilter === "S" ? "bg-orange-900 text-white" : ""
                  }`}>
                  S
                </button>
                <button
                  ...
                  className={`p-2 text-center bg-white rounded-md min-w-14 ${
                    sizeFilter === "M" ? "bg-orange-900 text-white" : ""
                  }`}>
                  M
                </button>
                <button
                  ...
                  className={`p-2 text-center bg-white rounded-md min-w-14 ${
                    sizeFilter === "L" ? "bg-orange-900 text-white" : ""
                  }`}>
                  L
                </button>
              </div>
            ...
            <div className="flex items-center">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`p-2 text-center bg-white  rounded-md min-w-14 ${
                    colorFilter === null ? "bg-orange-900 text-white" : ""
                  }`}>
                  All
                </button>
                <button
                  ...
                  className={`p-2 text-center bg-white  rounded-md min-w-14 ${
                    colorFilter === "white" ? "bg-orange-900 text-white" : ""
                  }`}>
                  White
                </button>
                <button
                  ...
                  className={`p-2 text-center rounded-md bg-white min-w-14 ${
                    colorFilter === "brown" ? "bg-orange-900 text-white" : ""
                  }`}>
                  Brown
                </button>
                <button
                  ...
                  className={`p-2 text-center rounded-md bg-white  min-w-14 ${
                    colorFilter === "black" ? "bg-orange-900 text-white" : ""
                  }`}>
                  Black
                </button>
              </div>
